...
## Project Structure
    ...
    ├── jon_sons_pool_clean_36113  # Django project configurations
...
1. Clone this repo and `cd jon_sons_pool_clean_36113`
...
2. Clone this repo and `cd jon_sons_pool_clean_36113`
